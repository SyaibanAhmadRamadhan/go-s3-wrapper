...
func (m *MockS3Client) GetObject(ctx context.Context, input GetObjectInput) (GetObjectOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetObject", ctx, input)
	ret0, _ := ret[0].(GetObjectOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockS3Client) PresignedUrlGetObject(ctx context.Context, input PresignedUrlGetObjectInput) (PresignedUrlGetObjectOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PresignedUrlGetObject", ctx, input)
	ret0, _ := ret[0].(PresignedUrlGetObjectOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockS3Client) PresignedUrlUploadObject(ctx context.Context, input PresignedUrlUploadObjectInput) (PresignedUrlUploadObjectOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PresignedUrlUploadObject", ctx, input)
	ret0, _ := ret[0].(PresignedUrlUploadObjectOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
